...
function About() {
  return (
   ...
   <div style={{margin:"auto",width:"60%",marginTop:"90px"}}>
    <img  src="https://media.istockphoto.com/id/1273425452/photo/multi-generation-hispanic-family-at-home-during-coronavirus-pandemic-quarantine.jpg?s=2048x2048&w=is&k=20&c=jrPHZZC7AFF0nLkE3E7o1ZP2_3I4Fqq_0Rf6BMEEi7c=" alt="" />
    <p style={{marginRight:"30px",fontSize:"15px",textAlign:"center"}}>Pictured from left to right: Rose Lord, Leslie Nolen, Philipp Kaiser, Marian Goodman, Junette Teng, and Emily-Jane Kirwan.</p>
   </div>
   <div style={{width:"96%",margin:"auto",marginTop:"100px"}}>
   ...
   <div className='om'>
    <img className='om1' src="https://images.unsplash.com/photo-1506869640319-fe1a24fd76dc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z3JvdXB8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt="" />
   </div>
   <div className='om2'>
