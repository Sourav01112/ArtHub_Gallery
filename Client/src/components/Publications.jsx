            ...
            <div style={{width:"100%",marginBottom:"30px"}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(3,30%)",justifyContent:"space-around",textAlign:"center"}}>
                    <div>
                        ...
                        <p style={{fontSize:"13px",marginTop:"20px"}}>The lighthouse on the island of Santa Clara in <br />
                    ...
                    <div>
                        ...
                        <hr />
                        <h2 style={{fontFamily:"'Playfair Display', serif"}}>Cristina Iglesias: Hondalea</h2>
                        <p style={{fontSize:"13px",marginTop:"20px"}}>The lighthouse on the island of Santa Clara in 
                            Donostia / San Sebastián stood empty for many years until 
                            Cristina Iglesias transformed it into a breath-taking sculptural work
